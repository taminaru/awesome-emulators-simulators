# Awesome Emulators & Simulators [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome)
...
##### Altair
As of now there are no guides on how to install or download the Altair8800 emulator.
##### Apple
* Apple I  - Download it from [sourceforge](pom1.sourceforge.net/?page=downloads), and then run it.
Alternatively, user of the Arch Linux distribution can use the following [AUR Package](https://aur.archlinux.org/packages/pom1/).
* Apple II - Follow the compiling guide [here](https://github.com/AppleWin/AppleWin/blob/master/docs/compiling.txt).
##### Commodore
...
### Consoles
##### Nintendo
* FCEUX   - Follow the guide [here](https://fceux.com/web/download.html).
* Snes9x  - Go to the [official download section](https://snes9x.com/downloads.php) and select one of the mirrors.
* Mupen64 - Get the latest official release from the [Github page](https://github.com/mupen64plus/mupen64plus-core/releases).
* Dolphin - Get the latest version from the [official website](https://dolphin-emu.org/download/?ref=btn).
* DeSmuME - Get the latest version from the [official website](https://desmume.org/download).
* Citra   - Look in the download section of the [official website](https://citra-emu.org/download/).
##### Sony
* PCSX2  - Get the latest version for your operating system from the [official website](https://pcsx2.net/download.html).
* PPSSPP - Get the latest version for your operating system from the [official website](https://ppsspp.org/downloads.html).
* RPCS3  - Follow the guide [here](https://rpcs3.net/download). 
##### Microsoft
* xqemu - Follow the [Getting Started guide](https://xqemu.com/getting-started).
* xenia - Download the latest release from [Github](https://github.com/xenia-project/xenia/blob/master/README.md).
##### Sega
* Genesis-Plus-GX - Enable it from an emulator frontend (RetroArch, OpenEmu).
##### Atari
* stella - Get the latest release from the [official website](https://stella-emu.github.io/downloads.html).
* atari800 - Download the latest release from [Github](https://github.com/atari800/atari800/releases).
##### Multi-emulators
* RetroArch - Download the latest release from [Github](https://github.com/libretro/RetroArch/releases).
* OpenEmu - Press the 'Download' button from the [official website](https://openemu.org).
### OSes
#### Linux based
* RetroPie - Download the ISO from the [official website](https://retropie.org.uk/download) and [flash it unto an USB or SD card](https://howtogeek.com/191054/how-to-create-bootable-usb-drives-and-sd-cards-for-every-operating-system/).
* Lakka    - Download the ISO from the [official website](https://lakka.tv/get) and [flash it unto an USB or SD card](https://howtogeek.com/191054/how-to-create-bootable-usb-drives-and-sd-cards-for-every-operating-system/).
* Batocera - Download the ISO from the [official website](https://batocera.org/download) and [flash it unto an USB or SD card](https://howtogeek.com/191054/how-to-create-bootable-usb-drives-and-sd-cards-for-every-operating-system/).
